...
namespace BusBus.UI
{
    ...
    public partial class RouteEditForm : Form
    {
        ...
        private async Task LoadDataAsync()
        {
            ...
            {
                // Load vehicles
                var vehicles = await _vehicleService.GetAllVehiclesAsync(CancellationToken.None);
                ...
                // Load drivers
                var drivers = await _driverService.GetAllDriversAsync(CancellationToken.None);
        ...
        private async void SaveButton_Click(object? sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (_isNewRoute)
                {
                    ...
                    route.IsActive = true;
                    await _routeService.CreateAsync(route, CancellationToken.None);
                }
                else
                {
                    route.ModifiedDate = DateTime.Now;
                    await _routeService.UpdateAsync(route, CancellationToken.None);
                }
